    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var item in dept) {
                tr += "<tr>";
                tr += "<td>" + dept[item]["deptNo"] + "</td>" + "<td>" + dept[item]["deptName"] + "</td>";
                tr += "<td>" + dept[item]["deptDesc"] + "</td>" ;
                tr += "<td><input type='hidden' value=" + dept[item]["id"] + " /><a class='deldept'  href='javascript:void(0);'>删除</a></td>";
                tr += "</tr>";
            }
...
$(function () {
    ...
    //绑定删除商品分类事件
    $(".table").on("click", ".deldept", function () {
