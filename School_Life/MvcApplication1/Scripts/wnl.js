...
(function (e, t) {
    "use strict";
    typeof exports != "undefined" ? exports.Mediator = t() : typeof define == "function" && define.amd ? define("mediator-js", [],
    function () {
        return e.Mediator = t(),
        e.Mediator()
    }) : e.Mediator = t()
...
function () {
    ...
    n.prototype = {
        addSubscriber: function (e, n, r) {
            var i = new t(e, n, r);
            return n && n.priority !== undefined ? (n.priority = n.priority >> 0, n.priority < 0 && (n.priority = 0), n.priority >= this._subscribers.length && (n.priority = this._subscribers.length - 1), this._subscribers.splice(n.priority, 0, i)) : this._subscribers.push(i),
            i.channel = this,
            i
        },
        ...
        setPriority: function (e, t) {
            ...
            i = this._subscribers[n],
            s = this._subscribers.slice(0, n),
            o = this._subscribers.slice(n + 1),
            this._subscribers = s.concat(o),
        ...
        removeSubscriber: function (e) {
            ...
            for (t; t >= 0; t--) if (this._subscribers[t].fn === e || this._subscribers[t].id === e) this._subscribers[t].channel = null,
        ...
        publish: function (e) {
            ...
            r = !1,
            i, s, o, u;
            for (t, n; t < n; t++) this.stopped || (i = this._subscribers[t], i.options !== undefined && typeof i.options.predicate == "function" ? i.options.predicate.apply(i.context, e) && (i.fn.apply(i.context, e), r = !0) : (o = this._subscribers.length, i.fn.apply(i.context, e), u = this._subscribers.length, n = u, u === o - 1 && t--, r = !0)),
            r && i.options && i.options !== undefined && (i.options.calls--, i.options.calls < 1 && (this.removeSubscriber(i.id), n--, t--));
    ...
    r.prototype = {
        getChannel: function (e) {
            ...
            i = n.length;
            if (e === "") return t;
            if (n.length > 0) for (r, i; r < i; r++) t.hasChannel(n[r]) || t.addChannel(n[r]),
            t = t.returnChannel(n[r]);
            return t
        },
    ...
    $.format = function () {
        ...
        r = [],
        i = e[0];
        return e = $.isArray(i) ? i : typeof i == "object" ? e : [e],
        $.each(e,
        function (e, i) {
            r.push(n.replace(t || (t = /\{([\d\w\.]+)\}/g),
            function (t, n, r) {
                return r = n === "INDEX" ? e : n.indexOf(".") < 0 ? i[n] : $.route(i, n),
                r === undefined ? t : $.isFunction(r) ? r.call(i, n) : r
            }))
        }),
        r.join("")
    };
    ...
    r.prototype = {
        ...
        getCalendarFirstDate: function () {
            ...
            t = e.getDay();
            return e.setDate(e.getDate() - (t == 0 ? 6 : t - 1)),
            e
        }
    },
    ...
    function n(t) {
        this.oDate = t,
        this.julianDay = s.fromDate(this.oDate),
        this.cnDay = this.oDate.getDay() ? e.digitCN[this.oDate.getDay()] : "\u65e5";
        ...
        for (var a = Math.round(n - u[0].JD), f = 0, l; f < u.length; f++) {
            l = u[f];
            if (a < l.days) {
                this.isBigMonth = l.days == 30,
                this.isLeap = l.isLeap,
                this.lMonth = l.name,
                this.lNextMonth = l.nextName,
                this.lDate = e.dateCn[a],
                this.dateIndex = a;
                break
            }
            a -= l.days
        ...
        n = Math.round(n),
        this.lYear = Math.floor((o[3].JD + (n < o[3].JD ? -365 : 0) + 5844 - 35) / 365.2422 + .5);
        var c = u[u.zyIndex].JD;
        c -= n < c ? 365 : 0,
        c += 5810,
        this.sYear = Math.floor(c / 365.2422 + .5),
        this.hYear = this.sYear + 1984 + 2698;
        var c = o.hash[n];
        this.term = c ? c.name : "";
        var c = this.lYear + 6e3;
        this.animal = e.chineseZodiac[c % 12],
        this.db = e,
        this.gzYear = e.heavenlyStems[c % 10] + e.earthlyBranches[c % 12];
        var c = Math.floor((n - o[0].JD) / 30.43685);
        c < 12 && n >= o[2 * c + 1].JD && c++,
        c += Math.floor((o[12].JD + 390) / 365.2422) * 12 + 9e5,
        this.gzMonth = e.heavenlyStems[c % 10] + e.earthlyBranches[c % 12];
        var c = n - 6 + 9e6;
        this.gzDate = e.heavenlyStems[c % 10] + e.earthlyBranches[c % 12],
        this.gzChrono = e.earthlyBranches[Math.floor((this.oDate.getHours() + 1) / 2)] || "\u5b50"
    }
    function h(e) {
    ...
    function d(e) {
        ...
        i = 0,
        s = c;
        for (t = 0; t < s.length; t += 5) t == 0 ? n = -1.742 * e : n = 0,
        i += (s[t + 3] + n) * Math.sin(s[t] + s[t + 1] * e + s[t + 2] * r);
        return i / 100 / f
    }
    function v(e) {
    ...
    function y(e, t, n, r) {
        ...
        if (e == 0) {
            var b = n * n,
            w = b * n;
            t == 0 && (a += (-0.0728 - 2.7702 * n - 1.1019 * b - .0996 * w) / f),
            t == 1 && (a += (0 + 4e-4 * n + 4e-4 * b - .0026 * w) / f),
    ...
    function b(e, t, n) {
        ...
        m = v * t,
        g = t - 10;
        e == 0 && (l += (3.81034409 + 8399.684730072 * t - 3319e-8 * p + 3.11e-8 * d - 2.033e-10 * v) * f, l += 5028.792262 * t + 1.1124406 * p + 7699e-8 * d - 23479e-9 * v - 1.78e-8 * m, g > 0 && (l += -0.866 + 1.43 * g + .054 * g * g)),
        p /= 1e4,
        d /= 1e8,
        v /= 1e8,
        n *= 6,
        ...
        for (i = 0; i < r.length; i++, c *= t) {
            o = r[i],
            u = Math.floor(n * o.length / r[0].length + .5),
            i && (u += 6),
    ...
    r = {
        ...
        calcForLow: function (e) {
            ...
            n = (e + 1.08472) / t,
            r;
            return n -= (-0.0000331 * n * n + .10976 * Math.cos(.785 + 8328.6914 * n) + .02224 * Math.cos(.187 + 7214.0629 * n) - .03342 * Math.cos(4.669 + 628.3076 * n)) / t + (32 * (n + 1.8) * (n + 1.8) - 20) / 86400 / 36525,
            n * 36525 + 8 / 24
        },
        ...
        getNewMoons: function (t) {
            ...
            if (r.cache[i]) s = r.cache[i];
                ...
                s[o].nextName = (s[o + 1].isLeap ? "\u95f0" : "") + e.monthCn[s[o + 1].index % 12],
                s[o].index == 2 && (s.zyIndex = o);
                r.cache[i] = s
            }
            return s
        },
        calc: function (e) {
            ...
            if (e >= i && e < o) return t = Math.floor(this.calcForLow(Math.floor((e + r - 2451551) / 29.5306) * Math.PI * 2) + .5),
            n = this.correction.substr(Math.floor((e - i) / 29.5306), 1) - 0,
            t + (n ? n - 2 : n)
        }
    },
    i = {
        ...
        calcForLow: function (e) {
            ...
            return t = (e - 4.895062166) / r,
            t -= (53 * t * t + 334116 * Math.cos(4.67 + 628.307585 * t) + 2061 * Math.cos(2.678 + 628.3076 * t) * t) / r / 1e7,
            ...
            t -= (n / 1e7 - e) / 628.332 + (32 * (t + 1.8) * (t + 1.8) - 20) / 86400 / 36525,
            t * 36525 + 8 / 24
        },
        getNearestWinter: function (e) {
            var t = Math.floor((e - 355 + 183) / 365.2422) * 365.2422 + 355;
            return i.calc(t) > e && (t -= 365.2422),
            t
        },
        cache: {},
        getTerms: function (t) {
        ...
        calc: function (e) {
            ...
            if (e >= o && e < u) return n = Math.floor(this.calcForLow(Math.floor((e + i - 2451259) / 365.2422 * 24) * Math.PI / 12) + .5),
            r = this.correction.substr(Math.floor((e - o) / 365.2422 * 24), 1) - 0,
            n + (r ? r - 2 : r)
        }
    },
    s = {
        ...
        fromDate: function (e) {
            ...
            s = 0;
            return n <= 2 && (n += 12, t -= 1),
            i && (s = Math.floor(t / 100), s = 2 - s + Math.floor(s / 4)),
            Math.floor(365.25 * (t + 4716)) + Math.floor(30.6001 * (n + 1)) + r + s - 1524.5
        }
    },
    ...
    w = {
        ...
        MS_aLon_t: function (e) {
            ...
            return t = (e + 1.08472) / n,
            t += (e - this.MS_aLon(t, 3, 3)) / n,
            n = this.M_v(t) - this.E_v(t),
            t += (e - this.MS_aLon(t, 20, 10)) / n,
            t += (e - this.MS_aLon(t, -1, 60)) / n,
            t
        },
        S_aLon_t: function (e) {
            var t, n = 628.3319653318;
            return t = (e - 1.75347 - Math.PI) / n,
            n = this.E_v(t),
            t += (e - this.S_aLon(t, 10)) / n,
            n = this.E_v(t),
            t += (e - this.S_aLon(t, -1)) / n,
            t
        },
        MS_aLon_t2: function (e) {
            ...
            t = (e + 1.08472) / n;
            var r, i = t * t;
            return t -= (-0.00003309 * i + .10976 * Math.cos(.784758 + 8328.6914246 * t + 152292e-9 * i) + .02224 * Math.cos(.1874 + 7214.0628654 * t - 21848e-8 * i) - .03342 * Math.cos(4.669257 + 628.307585 * t)) / n,
            r = this.M_Lon(t, 20) - (4.8950632 + 628.3319653318 * t + 5297e-9 * t * t + .0334166 * Math.cos(4.669257 + 628.307585 * t) + 2061e-7 * Math.cos(2.67823 + 628.307585 * t) * t + 349e-6 * Math.cos(4.6261 + 1256.61517 * t) - 20.5 / f),
            n = 7771.38 - 914 * Math.sin(.7848 + 8328.691425 * t + 1523e-7 * t * t) - 179 * Math.sin(2.543 + 15542.7543 * t) - 160 * Math.sin(.1874 + 7214.0629 * t),
            t += (e - r) / n,
            t
        },
        S_aLon_t2: function (e) {
            var t, n, r = 628.3319653318;
            return t = (e - 1.75347 - Math.PI) / r,
            t -= (5297e-9 * t * t + .0334166 * Math.cos(4.669257 + 628.307585 * t) + 2061e-7 * Math.cos(2.67823 + 628.307585 * t) * t) / r,
            t += (e - this.E_Lon(t, 8) - Math.PI + (20.5 + 17.2 * Math.sin(2.1824 - 33.75705 * t)) / f) / r,
            t
        }
    };
    window.OB.RiLi.Lunar = n,
    window.OB.RiLi.lunar = t;
    ...
    n.prototype.festival = function () {
        ...
        f = u + "\u6708" + a,
        l = [];
        this.lNextMonth == "\u6b63" && a == (this.isBigMonth ? "\u4e09\u5341" : "\u5eff\u4e5d") && l.push("v,\u9664\u5915"),
        x.w[o] && (l = l.concat(x.w[o].split("|"))),
        x[f] && (l = l.concat(x[f].split("|"))),
        x[r] && (l = l.concat(x[r].split("|")));
    ...
    function f(e) {
        var o = (new Date).getTime(); !s || Math.abs(o - s) > t * 3 ? a(e) : (s = o, Math.abs(r - i) > n && (o = r - i + o)),
        e && e(new Date(o))
    }
    $.ajaxSetup({
        cache: !0
        ...
        getHuochepiaoDay: function (e, t, n) {
            ...
            for (var h = 0; h < i.length; ++h) {
                ...
                if (r.cmd == "<" && l <= r.date || r.cmd == "=" && l == r.date || r.cmd == ">" && l >= r.date) {
                    c = +(new Date([e, t, n].join("/"))) + (r.delta - 1) * 864e5,
                    u.piaodate = new Date(c);
                    break
                }
            }
            return s.min <= l && s.max >= l && (u.color = s.color),
            u
        },
    ...
    $.widget("rili.fakeSelect", {
        ...
        _create: function () {
            ...
            n = this.options;
            this.name = n.name,
            this.prev = t.find(".mh-prev"),
            this.next = t.find(".mh-next"),
            this.cont = t.find("div.mh-control"),
            this.header = t.find(".mh-field"),
            this.list = t.find(".mh-list"),
            this.cont.find(".mh-holiday").length > 0 ? this.list.html($.format('<li val="{value}" is_sel={is_sel}>{text}</li>', n.data)) : this.list.html($.format('<li val="{value}">{text}</li>', n.data)),
            ...
            e.header.html(r.text()).attr("val", r.attr("val")),
            this.cont.find(".mh-holiday").length > 0 && (r = e.opts.filter('[is_sel="true"]'), r.length && e.header.html(r.text()).attr("val", r.attr("val"))),
    ...
    $.widget("rili.speCalendar", {
        ...
        _create: function () {
            var e = this.element;
            e.delegate("li.mh-spe-item", "mouseenter",
            function () {
                var e = $(this),
                t = e.find(".mh-spe-cover");
                t.show()
            }),
            e.delegate("li.mh-spe-item", "mouseleave",
            function () {
                var e = $(this),
                t = e.find(".mh-spe-cover");
                t.hide()
    ...
    $.format = function () {
        ...
        n = [],
        r = e[0];
        return e = $.isArray(r) ? r : typeof r == "object" ? e : [e],
        $.each(e,
        function (e, r) {
            n.push(t.replace(c || (c = /\{([\d\w\.]+)\}/g),
            function (t, n, i) {
    ...
    $.widget("rili.webCalendar", {
        ...
        _create: function () {
            ...
            this.tmplDate = '<li class="{monthClass}" date="{date}" data-md=\'{"p":"day-box"}\'><span class="mh-border"></span><div class="mh-solar">{solar}</div><span class="mh-lunar" {lunarTitle} >{lunar}</span>{goupiao}</li>',
            this.initTime(this.options.time),
            this.handleClick(),
            this.initDatePicker()
        },
        ...
        initTime: function (n) {
            ...
            this.now = new Date,
            this.today = e.today,
            this.initCalendar(u, a),
            this.options.onselect.call(s, o, i(o)),
            this._showCurrentTime(),
            r.publish(t.type.ctc, {
                data: o
            })
        },
        initCalendar: function (s, o, a) {
            ...
            e.action == "goupiao" && $(".mh-dates").addClass("mh-goupiao-dates");
            var g = {},
            y = {},
            b = {},
            w = e.dateRest;
            ...
            function (s, a) {
                ...
                x = c + E + "";
                $.inArray(x, f) != -1 && w.push("mh-fes"),
                h != o - 1 && w.push("mh-cross-month"),
                (a + 1) % 7 == 0 && w.push("mh-last"),
                p == m.getDate() && h == m.getMonth() && c == m.getFullYear() && w.push("mh-today"),
                (d == 0 || d == 6) && w.push("mh-weekend");
                var T = v.festival();
                v.term ? w.push("mh-solar-style") : T.length && w.push("mh-" + T[0].type + "solar-style"),
                c == u && (g[E] && w.push(g[E], "mh-vacation"), y[E] && w.push(y[E]));
                if (b[u + E]) {
                ...
                e.action == "goupiao" ? goupiao = n.getHuochepiaoDayHtml(c, h + 1, p) : goupiao = "";
                var C, k;
                return C = T[0] && T[0].desc.length < 9 && T[0].desc || v.term || v.dateIndex == 0 && v.lMonth + "\u6708" + (v.isBigMonth ? "\u5927" : "\u5c0f") || v.lDate,
                C.length > 4 ? $.format(N, {
                    monthClass: w.join(" "),
                    solar: p,
                    lunar: C,
        ...
        handleClick: function () {
            ...
            function () {
                ...
                c = t.returnValue,
                l == n.month && f == n.year || !c ? (o.onselect.call(n, a, i(a)), r.publish(t.type.ctc, {
                    data: a
        ...
        initDatePicker: function () {
            ...
            o = function (e) {
                ...
                this.name == "year" ? (i = e, r.publish(t.type.fgv, {
                    ...
                    data: {},
                    from: n.dltYear
                }), i = t.returnValue, s = e, e = i + ("0" + s).slice(-2)),
                n.initCalendar(i, s),
                r.publish(t.type.fsv, {
                    data: e,
                    from: n.dltFestival
            ...
            f = function (i) {
                ...
                for (var v = 0; v < f.length; ++v) {
                    ...
                    if (l[0].slice(0, 8) == c + h + p) {
                        d = s + "/" + o + "/" + (l[0].slice(-2) - 0) + "",
                        d != "2014/2/1" ? $("li[date='" + d + "']").click() : typeof e.CallBack.holiday == "function" && e.CallBack.holiday("\u6625\u8282", s);
                        break
                    }
                }
            };
            this.dltYear = i.find("div.mh-year-bar"),
            this.dltMonth = i.find("div.mh-mouth-bar"),
            this.dltFestival = i.find("div.mh-holiday-bar");
            var l = [];
            l.push({
                value: "",
                text: u + "\u5e74\u5047\u65e5\u5b89\u6392"
            ...
            function (e, t) {
                ...
                n.value = i,
                n.text = s,
                i.substr(0, 8) == c.getFullYear() + h + p ? n.is_sel = !0 : n.is_sel = !1,
                l.push(n)
            }),
            setTimeout(function () {
    ...
    $.widget("rili.dayDetail", {
        ...
        _create: function () {
            ...
            n = this.options;
            this.tmpl = [],
            this.tmpl.push('<div class="mh-dates-bar">'),
            this.tmpl.push('<span class="mh-date">{year}-{padmonth}-{paddate}</span>'),
            this.tmpl.push('<span class="mh-weekday">{week}</span>'),
            this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-date-show-panel">'),
            this.tmpl.push("{date}"),
            this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-desc">'),
            this.tmpl.push('<div class="mh-lunar">\u519c\u5386{lmonth}\u6708{ldate}</div>'),
            this.tmpl.push('<div class="mh-lunar-ganzhi">'),
            this.tmpl.push("{gzyear}\u5e74{gzmonth}\u6708{gzdate}\u65e5"),
            this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-other-info">'),
            this.tmpl.push('<span class="mh-animal-year">[<em class="mh-animal">{animal}\u5e74</em>]</span>'),
            this.tmpl.push('<span class="mh-astro">{astro}</span>'),
            this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-lunar-term">'),
            this.tmpl.push("{festival}"),
            this.tmpl.push("</div>"),
            this.tmpl.push("</div>"),
            this.tmpl = this.tmpl.join("")
        },
        init: function (n, r) {
            var i = this,
            s = $(this.element),
        ...
        loadLuckyData: function (e, t, n) {
            ...
            u && u["y" + e] ? this.fillLuckyData(u["y" + e][o]) : e > 2007 && e < 2021 ? (clearTimeout(window.OB.RiLi.getHandle), window.OB.RiLi.getHandle = setTimeout(function () {
                $.getScript(window.OB.RiLi.hlUrl[e],
                function () {
        ...
        fillLuckyData: function (e) {
            ...
            $(".mh-suited .mh-st-items").html(t(s)).attr("title", s.join(" ")),
            $(".mh-tapu .mh-st-items").html(t(o)).attr("title", o.join(" "))
        }
    })
})(); (function () {
    ...
    n = function () {
        ...
        if (t) {
            ...
            r;
            for (var i = 0; i < n.length; ++i) r = n[i].split("="),
            e[r[0]] = r[1]
        }
        return e
    };
