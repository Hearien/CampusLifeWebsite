...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <link href="../../Content/calender.css" rel="stylesheet" type="text/css" />
...
window.hd_init = function () {
    ...
    <div id="calender" class="row col-md-12">
    <!-- BEGIN #main -->
        <div id="main">
        ...
        <select class="mh-holiday-data" style="display:none;">
	        <option value="0" data-desc="" data-gl="">放假安排</option>
              ...
              <!--value获取当前PHP服务器时间-->
        <input type="hidden" id="mh-rili-params" value="action=query&year=2017&month=02&day=02" />
        ...
        <script>
            ...
            */
            ...
            _loader.add("rili-widget", "/Scripts/wnl.js"); //上述JS文件们已让我压缩成wnl.js
