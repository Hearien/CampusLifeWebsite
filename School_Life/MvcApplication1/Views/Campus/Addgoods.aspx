...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form class="form-horizontal" action="/Campus/Addgoods" method="post" role="form">
    <div class="col-md-12">
    <div class="col-md-8">
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type="text" name="note" class="form-control" id="note" placeholder="请输入附加商品信息">
        </div>
        <div class="col-md-3">
            <span class=""></span>
            <span class="text-danger note"></span>
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" rename="price" name="price" id="price" placeholder="请输入商品价格">
        </div>
        <div class="col-md-3">
             <span class=""></span>
             <span class="text-danger note"></span>
    ...
    <div class="col-md-4">
        <img src="../../img/campus2.png" id="preImg" width="200" class="img-thumbnail img-responsive" />
    </div>
    </div>
      <div class="form-group">
        <label for="detail" class="col-md-1 control-label">详情</label>
        <div class="col-md-11">
            <%=Html.TextArea("Editor1", new {cols = "100", rows = "50" })%>
        </div>
        <div>
             <span class=""></span>
             <span class="text-danger note"></span>
